...
- (void)checkWithPayload:(NSData *)data acceptedCompletionHandler: (void(^)(NSString * transactionId))acceptedCompletionHandler rejectedCompletionHandler: (void(^)(NSString * transactionId, NSString  * reason))rejectedCompletionHandler errorCompletionHandler: (void(^)(NSError * error))errorCompletionHandler willDisplayLoginDialogHandler: ( void(^ _Nullable )(void))willDisplayLoginDialogHandler  didHideLoginDialogHandler: (void(^ _Nullable )(void))didHideLoginDialogHandler;
NS_ASSUME_NONNULL_END
@end
